...
const AttachmentUpload = ({ attachments, setAttachments, fileRef, addFiles }) => {
  ...
  return (
    <div>
      ...
      <div
        ...
        className="border-2 border-dashed border-slate-200 rounded-[10px] py-[11px] text-center cursor-pointer bg-slate-50 hover:bg-indigo-50 hover:border-indigo-500 transition"
      >
